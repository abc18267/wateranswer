---
title: 'How to Shock Chlorinate a Well: EPA Method Step by Step'
description: 'Shock chlorination kills bacteria in a contaminated well. Here''s the EPA-recommended process, how much bleach to use, and when to retest.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'how to shock chlorinate a well'
silo: 'your-water'
pageType: 'spoke'
layout: 'spoke'
...
showDisclaimer: true
steps:
  - name: 'Put on protective gear'
    text: 'Wear gloves and eye protection before handling bleach.'
  - name: 'Remove the well cap'
    text: 'Remove the well cap carefully and set it aside somewhere clean.'
  - name: 'Mix bleach solution'
    text: 'Measure the calculated amount of bleach and mix it into 5 gallons of water in a clean bucket. Add bleach to water to reduce splashing.'
  - name: 'Pour bleach into the well'
    text: 'Pour the bleach solution into the well casing using a funnel.'
  - name: 'Circulate the bleach'
    text: 'Connect a garden hose to an outdoor spigot and run water into the open well casing for 15-20 minutes to circulate the solution.'
  - name: 'Replace the well cap'
    text: 'Replace the well cap securely.'
  - name: 'Check all taps for chlorine smell'
    text: 'Open each faucet one at a time until you detect a strong chlorine smell, then close it. Work through every faucet to confirm chlorinated water reached all pipes.'
  - name: 'Let the solution sit'
    text: 'Let the chlorinated water sit in the well and all pipes for a minimum of 8 hours. Overnight (12-24 hours) is better. Do not use water during this period.'
  - name: 'Flush the system'
    text: 'Run an outdoor spigot until the chlorine smell clears (1-3 hours). Then briefly flush each interior faucet.'
  - name: 'Wait and retest'
    text: 'Wait 10-14 days, then submit a water sample to a certified lab for bacteria testing. Testing too soon risks a false negative from residual chlorine.'
faq:
...
For an **8-inch casing**, multiply the above by 1.75.
For a **4-inch casing**, use about two-thirds of the 6-inch amount.
...
For wells where bacteria is a recurrent problem, a [UV water purifier](/treatment/best-uv-water-purifiers/) installed after filtration provides continuous protection between annual tests, though it doesn't fix the underlying source issue.

See the [well water testing guide](/your-water/well-water/well-water-testing-guide/) for guidance on finding a certified lab and collecting samples correctly. The [bacteria in well water page](/your-water/contaminants/bacteria/) covers health risks and long-term management options.
