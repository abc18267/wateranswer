---
title: "How to Test Your Well After a Flood or Hurricane"
description: "Test well water after flood events before you drink it. Flooding contaminates private wells fast. Here's what to test, when to test, and what to do if results are positive."
date: 2026-02-22
lastmod: 2026-02-22
primaryKeyword: "test well water after flood"
silo: "your-water"
pageType: "spoke"
layout: "spoke"
...
faq:
  - question: 'How soon should I test my well after a flood?'
    answer: 'Test as soon as you can safely access the well after the flood recedes. Don''t wait weeks. Many state labs offer expedited results in 24 to 48 hours for post-disaster samples. Until you have clean results in hand, treat the water as contaminated and use bottled water for all drinking, cooking, and tooth-brushing.'
  - question: 'Can I use well water to wash dishes after a flood?'
    answer: 'Not until testing confirms it''s safe. Bacteria from floodwater can survive on dishes and utensils even after washing. If you have no other option, use the hottest water available and a sanitizing dish soap. But the safest move is to use bottled water for anything that touches food or your mouth until results come back clear.'
  - question: 'Does boiling water make it safe to drink after a flood?'
    answer: 'Boiling kills bacteria, including E. coli and coliform. But it does not remove nitrates, heavy metals, or chemical contaminants. If there''s any chance of agricultural runoff or a chemical spill near your well, boiling alone isn''t enough. Use bottled water in those cases. Boiling is an acceptable backup only when bacterial contamination is your sole concern.'
  - question: 'How do I shock chlorinate my well after flooding?'
    answer: 'The EPA''s shock chlorination guide at epa.gov/privatewells walks through the process step by step. The basic method involves adding a diluted bleach solution to the well, running water through every tap until you smell chlorine, then waiting 24 hours before flushing the system. After flushing, wait several more days before retesting. Retest before resuming normal use.'
  - question: 'My well tested positive for bacteria after a flood. What do I do now?'
    answer: 'Shock chlorinate the well immediately. After the 24-hour contact period, flush the system and retest. If the well tests positive a second time, the casing or structure is likely damaged. Contact a licensed well contractor. There may be a physical entry point that chlorination alone won''t fix. A clean test result after one chlorination cycle is common, but don''t skip the retest.'
---
...
For more on what bacterial contamination in well water means, see our [guide to bacteria in well water](/your-water/contaminants/bacteria/).

**Nitrates if you're near farmland.** Agricultural runoff during flooding carries fertilizers. Elevated nitrates are especially dangerous for infants under six months old. They cause methemoglobinemia, sometimes called blue baby syndrome. If your well is in or near a farming area, add a nitrate panel to your order. Learn more about [nitrates in drinking water](/your-water/contaminants/nitrates/).
...
Our [best mail-in water tests guide](/testing/best-mail-in-water-tests/) covers certified lab options if your state lab has a backlog. Make sure any mail-in lab is certified for drinking water testing in your state.

You can also check the [full well water testing guide](/your-water/well-water/well-water-testing-guide/) for how to collect a sample correctly. A contaminated sample bottle or improper collection technique can produce a false negative.

## If the Test Comes Back Positive

A positive result for bacteria is common after flooding. It's fixable, but it takes time.

Shock chlorinate the well immediately. The EPA has a free step-by-step guide at [epa.gov/privatewells](https://www.epa.gov/privatewells). The process involves adding a diluted household bleach solution to the well casing, flushing every tap until you smell chlorine, and letting the system sit for 24 hours. After that contact period, flush again and wait several days before retesting.
