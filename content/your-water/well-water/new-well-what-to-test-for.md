---
title: 'New Well Water: What to Test Before You Drink a Drop'
description: 'A new well gets a basic bacteria test at completion. That''s not enough. Here''s the full initial test panel, why each item matters, and how to interpret what you find.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'new well what to test for'
silo: 'your-water'
pageType: 'spoke'
layout: 'spoke'
...
**Nitrates:** The EPA MCL for nitrates is 10 mg/L. Nitrates in new wells can come from agricultural runoff, septic systems, or naturally occurring geological sources. Elevated nitrates are a concern for infants under 12 months. See the [nitrates in well water page](/your-water/contaminants/nitrates/) for health information and risks.
...
**Iron and manganese:** Both are common in most aquifers. Iron above 0.3 mg/L causes staining and taste issues. Manganese has a health advisory at 0.3 mg/L lifetime exposure, 0.1 mg/L for infants. See the [manganese page](/your-water/contaminants/manganese/) for specifics.

**Arsenic:** The EPA MCL for arsenic is 10 ppb (0.01 mg/L). Naturally occurring geological arsenic is a real risk in specific regions. New Hampshire, Maine, Vermont, Massachusetts, and much of the Southwest (Arizona, Nevada, New Mexico) have documented elevated arsenic in groundwater. If you're in any of these areas, arsenic testing is not optional. The [USGS arsenic mapping](https://www.usgs.gov/mission-areas/water-resources/science/arsenic-and-drinking-water) shows regional risk by county.
...
Mail-in labs are also an option. The [best mail-in water tests review](/testing/best-mail-in-water-tests/) covers several that offer comprehensive well water panels with proper sample collection materials and certified lab analysis.
...
Any result above an EPA MCL requires action before using the water for drinking or cooking. The [well water treatment pages](/treatment/) cover options by contaminant. For arsenic specifically, see [how to remove arsenic from water](/treatment/how-to-remove-arsenic-from-water/).
