...
The [how often to test well water page](/your-water/well-water/how-often-test-well-water/) covers the full annual testing schedule and the situations that require testing outside the regular cycle. The [well water testing guide](/your-water/well-water/well-water-testing-guide/) covers how to find a certified lab and what each test involves.

For a mail-in option that's easy to do without finding a local lab, see the [best mail-in water tests review](/testing/best-mail-in-water-tests/).
