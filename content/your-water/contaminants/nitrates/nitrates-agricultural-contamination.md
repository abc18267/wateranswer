...
faq:
  - question: 'Which states have the most nitrate contamination in groundwater?'
    answer: 'Iowa, Illinois, Indiana, Nebraska, and Kansas consistently show the highest nitrate levels in private well testing. These states have intensive corn and soybean agriculture that depends on nitrogen fertilizers. The USGS National Water-Quality Assessment Program has tracked nitrate levels in domestic wells across these states for decades. Parts of California''s Central Valley also have severe nitrate problems from agricultural use.'
  - question: 'How do nitrates from farms get into well water?'
    answer: 'Nitrogen fertilizers applied to fields convert to nitrate in soil. Rain and irrigation water carry that nitrate downward through the soil into groundwater. Shallow wells are at greatest risk. Older, poorly constructed wells with shallow casings are especially vulnerable. Livestock waste from concentrated animal feeding operations (CAFOs) is a second major source, as the waste contains high nitrogen concentrations that leach into groundwater.'
  - question: 'Does a standard water softener remove nitrates?'
    answer: 'No. A conventional water softener exchanges calcium and magnesium ions for sodium, but it doesn''t remove nitrate. You need either reverse osmosis (NSF/ANSI 58 certified) or an ion exchange system specifically designed for nitrate removal. Standard carbon filters also don''t remove nitrates.'
  - question: 'How do I know if my well is at risk for nitrates?'
    answer: 'The main risk factors are: living in an agricultural area, having a shallow well (under 100 feet), older well construction, and proximity to livestock operations or fields where nitrogen fertilizers are applied. But location alone isn''t enough to know your level. A certified lab test for nitrates is the only reliable way to find out what''s in your specific well.'
  - question: 'Is nitrate in well water a problem only in rural areas?'
    answer: 'Mostly yes. Nitrate contamination from agriculture is concentrated in rural farming regions. Municipal water systems that draw from affected groundwater must treat to meet the 10 mg/L EPA limit. Private wells in those same rural areas have no such oversight, which is why private well owners in agricultural regions bear the most direct risk.'
---
...
If you test above 10 mg/L, you need treatment at your drinking water tap. Reverse osmosis (NSF/ANSI 58 certified) is the most practical option for most households. It reduces nitrates at the point of use, typically the kitchen sink. See [How to Remove Nitrates from Water](/treatment/how-to-remove-nitrates-from-water/) for a breakdown of your options.
...
For guidance on what to test and how to find a certified lab, see [Well Water Testing Guide](/your-water/well-water/well-water-testing-guide/) and [Best Mail-In Water Tests](/testing/best-mail-in-water-tests/).

---

**Sources:**

- USGS National Water-Quality Assessment Program: [https://www.usgs.gov/mission-areas/water-resources/science/national-water-quality-assessment-nawqa](https://www.usgs.gov/mission-areas/water-resources/science/national-water-quality-assessment-nawqa)
