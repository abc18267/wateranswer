...
faq:
  ...
  - question: 'Can you taste or smell nitrates in water?'
    answer: 'No. Nitrates are colorless, odorless, and tasteless. You can''t detect them without a test. Water that looks and smells clean can still have dangerously high nitrate levels. The only way to know your well''s nitrate concentration is to test it with a certified lab.'
  - question: 'Does boiling water remove nitrates?'
    answer: 'No. Boiling makes nitrate contamination worse. As water evaporates, the remaining water becomes more concentrated with nitrates. Never boil water as a treatment for nitrates. This is especially important for infant formula preparation. Use a reverse osmosis filter or distillation, or switch to bottled water certified for low nitrates.'
  - question: 'What water filter removes nitrates?'
    answer: 'Reverse osmosis systems certified to NSF/ANSI 58 remove roughly 85 to 95 percent of nitrates. Anion exchange systems (specifically designed for nitrate removal) are also effective. Distillation removes nitrates as well. Carbon filters, pitcher filters, and standard water softeners do not remove nitrates. Always check NSF certification before buying a filter for nitrate reduction.'
  - question: 'How often should I test my well water for nitrates?'
    answer: 'The EPA recommends testing private wells for nitrates at least once a year. Test more often if you live near farmland, a feedlot, or a septic system, or after a heavy rain following a drought. Test immediately if you have an infant in the home or a pregnancy. Some states offer free or low-cost well testing programs through their department of environmental quality.'
---
...
The USGS [National Water Quality Assessment program](https://www.usgs.gov/mission-areas/water-resources/science/national-water-quality-assessment-nawqa) has mapped nitrate contamination in groundwater across the country for decades. The pattern is consistent: the highest concentrations cluster in agricultural regions. Iowa, Illinois, Indiana, Nebraska, and Kansas regularly show elevated nitrate levels in private well water. The USGS also documented that [rainfall following drought conditions](https://www.usgs.gov/news/state-news-release/rainfall-following-drought-linked-historic-levels-nitrate-some-midwest-streams) can spike nitrate concentrations dramatically as stored nitrogen flushes through soil into waterways and groundwater.
...
A study published in *Environmental Health Perspectives* and indexed by PubMed documents the connection between nitrate-contaminated private well water and infant methemoglobinemia cases ([PMC1638204](https://pmc.ncbi.nlm.nih.gov/articles/PMC1638204/)). The risk is real, it's documented, and it's concentrated in rural families using private wells in agricultural areas.
...
For lab options and a full breakdown of what to test for, see [Best Mail-In Water Tests](/testing/best-mail-in-water-tests/).
...
For a full breakdown of treatment methods and what they do and don't address, see the [Treatment hub](/treatment/).
...
For help finding a certified lab in your area, see [Well Water Testing Guide](/your-water/well-water/well-water-testing-guide/).

---

**Sources:**

- EPA National Primary Drinking Water Regulations: [https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations)
- PMC study on blue babies and nitrate-contaminated well water: [https://pmc.ncbi.nlm.nih.gov/articles/PMC1638204/](https://pmc.ncbi.nlm.nih.gov/articles/PMC1638204/)
- USGS National Water Quality Assessment (NAWQA): [https://www.usgs.gov/mission-areas/water-resources/science/national-water-quality-assessment-nawqa](https://www.usgs.gov/mission-areas/water-resources/science/national-water-quality-assessment-nawqa)
- USGS rainfall/drought/nitrate study: [https://www.usgs.gov/news/state-news-release/rainfall-following-drought-linked-historic-levels-nitrate-some-midwest-streams](https://www.usgs.gov/news/state-news-release/rainfall-following-drought-linked-historic-levels-nitrate-some-midwest-streams)
