---
title: "Rotten Egg Smell in Well Water: Causes and How to Fix It"
description: "That rotten egg smell in your well water is hydrogen sulfide gas. Learn the real cause, how to diagnose it, and which treatments actually work."
date: 2026-02-22
lastmod: 2026-02-22
draft: false
primaryKeyword: "rotten egg smell well water"
silo: "your-water"
...
faq:
  ...
  - question: 'Why does only my hot water smell like rotten eggs?'
    answer: 'When only the hot water smells, the source is almost always your water heater, not your well. The magnesium anode rod inside most water heaters reacts with sulfate in the water and produces hydrogen sulfide gas. This is a chemical reaction inside the tank, not a contamination issue in your well. Replacing the magnesium anode with an aluminum/zinc anode typically solves it.'
  - question: 'Will a water filter remove the rotten egg smell?'
    answer: 'It depends on the concentration. Activated carbon filters work well for low levels of hydrogen sulfide. For moderate levels, aeration, which physically strips the gas out of the water, is more effective and doesn''t require replacing filter media as often. For high levels or a bacterial source, chlorination followed by carbon filtration is usually the right approach. No single filter type works for all cases, which is why testing and diagnosing the source first matters.'
  - question: 'What causes hydrogen sulfide in well water?'
    answer: 'Three main sources: sulfate-reducing bacteria living in low-oxygen groundwater, a chemical reaction between sulfate-rich water and iron or organic matter in the aquifer, and geological sources where the well is drilled through sulfur-bearing rock. A certified lab test can measure H2S levels and identify whether bacteria are present, which determines the right treatment approach.'
  - question: 'Does boiling water remove hydrogen sulfide?'
    answer: 'Boiling will drive off some hydrogen sulfide gas since H2S is volatile, but it''s not a practical treatment. You''d need to boil with the pot uncovered and the steam vented outside, and even then you wouldn''t remove it fully. Boiling also concentrates any other dissolved minerals in the water. Proper filtration or aeration is a much better solution.'
---
...
Source: [EPA Secondary Drinking Water Standards](https://www.epa.gov/sdwa/secondary-drinking-water-standards-guidance-nuisance-chemicals)
...
If you haven't tested your well recently, a full water quality panel makes sense at the same time. See our [well water testing guide](/your-water/well-water/well-water-testing-guide/) for what to include.
...
Iron filtration and H2S treatment aren't always compatible. Some iron filters are damaged by chlorination, for instance. If you have both problems, test for both before buying anything. See our [iron in well water page](/your-water/contaminants/iron/) for what to look for.
...
For treatment options and system reviews, visit the [treatment hub](/treatment/).
