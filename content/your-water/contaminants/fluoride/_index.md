---
title: "Fluoride in Drinking Water: What the Numbers Actually Mean"
description: "Three different fluoride numbers. Three different purposes. Learn which limit applies to what, and which filters actually remove fluoride from drinking water."
date: 2026-02-22
lastmod: 2026-02-22
draft: false
...
faq:
  ...
  - question: 'Does Brita filter fluoride?'
    answer: 'Standard Brita pitcher filters use activated carbon, which does not remove fluoride. Brita''s marketing does not claim fluoride removal, and independent testing confirms it. If you want to reduce fluoride at home, you need a reverse osmosis system certified to NSF/ANSI 58 or a filter specifically designed with activated alumina media.'
  - question: 'Why do some cities remove fluoride from water?'
    answer: 'Water fluoridation is a local policy decision. Some cities have ended fluoridation programs due to cost, community preference, or policy changes at the state level. Utah and Florida passed laws in 2025 removing the requirement for fluoridation. Whether a city fluoridates has no effect on the EPA''s enforceable safety limits — those apply regardless.'
...
The only way to know your well's fluoride level is to test it. A mail-in water test from a certified lab will include fluoride for about $30 to $50. If your result comes back above 4.0 mg/L, treatment is worth considering. See the [testing hub](/testing/) for certified lab options.
...
For removal options, see [How to Remove Fluoride from Water](/treatment/how-to-remove-fluoride/).

For testing, see [Best Mail-In Water Tests](/testing/best-mail-in-water-tests/) and the [testing hub](/testing/).

For well owners with specific concerns, the [well water guide](/your-water/well-water/well-water-testing-guide/) covers what to test for and how to prioritize.

---

**Sources:**

- EPA National Primary Drinking Water Regulations — [epa.gov](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations)
- EPA Secondary Drinking Water Standards — [epa.gov](https://www.epa.gov/sdwa/secondary-drinking-water-standards-guidance-nuisance-chemicals)
- HHS recommended fluoride level (0.7 mg/L, 2015) — [hhs.gov](https://www.hhs.gov/)
- CDC on community water fluoridation — [cdc.gov](https://www.cdc.gov/fluoridation/about/community-water-fluoridation-recommendations.html)
- NSF/ANSI 58 certified product database — [nsf.org](https://www.nsf.org)
