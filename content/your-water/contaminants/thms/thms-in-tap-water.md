---
title: "Trihalomethanes (THMs) in Tap Water: What They Are and Where Levels Are Highest"
description: "THMs form when chlorine reacts with organic matter in drinking water. The EPA limits total THMs at 80 ppb. Here's where levels are highest and how to reduce them."
date: 2026-02-27
lastmod: 2026-02-27
...
draft: false
faq:
  - question: 'What are the health effects of THMs in drinking water?'
    answer: 'The EPA and EPA''s National Toxicology Program classify chloroform, one of the main THM compounds, as a likely human carcinogen at high doses. Epidemiologic research has found associations between long-term THM exposure and bladder cancer risk. The research doesn''t show that any single exposure is dangerous, the concern is cumulative exposure over years and decades. The EPA''s 80 ppb limit is set to keep that long-term risk at acceptable levels for public systems.'
  - question: 'Can I reduce THMs by letting water sit uncovered?'
    answer: 'To some extent. THMs are volatile, and the lightest compounds (chloroform and similar) will off-gas over time if water is left uncovered in a wide, shallow container. Boiling drives off some THMs more quickly. But these methods don''t eliminate THMs completely. A granular activated carbon filter certified to NSF/ANSI 53 is more reliable and practical.'
  - question: 'Does a Brita filter remove THMs?'
    answer: 'A Brita with the Longlast+ filter (blue filter) is NSF/ANSI 53 certified for VOC reduction, which includes some THM compounds. The standard Brita filter (white) is NSF 42 only, which doesn''t cover THMs. Check the specific filter''s NSF certification, not just the pitcher brand, before assuming coverage.'
  - question: 'Are THMs in well water?'
    answer: 'Rarely. THMs form when chlorine disinfectants react with natural organic matter in water. Private wells aren''t treated with chlorine, so the reaction that creates THMs typically doesn''t occur. Well water may have other disinfection byproduct-like compounds from different reactions, but standard THMs from chlorination are a municipal water concern.'
  - question: 'My CCR shows 60 ppb total THMs. Is that dangerous?'
    answer: 'It''s within the federal limit of 80 ppb, which means your utility is in compliance. Whether 60 ppb poses a risk depends on your total exposure, the duration of your exposure, and your individual health factors. The EPA designed the 80 ppb limit to keep long-term cancer risk at an acceptable level for the general population. If you''re concerned, an activated carbon filter certified to NSF 53 for THM reduction will lower your intake from drinking water.'
---
...
Pitcher filter options and what they cover are detailed on our [best pitcher water filters page](/treatment/best-pitcher-water-filters/).
...
The practical implication for households: if your utility uses chloramines, your THM levels are likely lower. But different concerns apply. See our [chloramines contaminant page](/your-water/contaminants/chloramines/) for what changes when your utility uses chloramines.
