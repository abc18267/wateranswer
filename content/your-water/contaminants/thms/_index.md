---
title: "Trihalomethanes (THMs) in Tap Water: The Byproduct of Disinfection"
description: "Chlorine kills bacteria in tap water, but it also creates THMs. Learn what trihalomethanes are, where levels run highest, and how to reduce them."
date: 2026-02-22
lastmod: 2026-02-22
draft: false
primaryKeyword: "trihalomethanes in tap water"
silo: "your-water"
...
spokeCards:
  ...
  - title: "How to Remove Chlorine from Tap Water"
    description: "THMs form from chlorine reacting with organic matter. Removing chlorine at the tap also reduces disinfection byproducts."
    href: "/treatment/how-to-remove-chlorine-from-tap-water"
    badge: "Treatment"
faq:
...
The gap between the health goal and the enforceable limit exists because the MCL is set at what's technically and economically feasible to achieve in real water systems, not at the zero-risk level. Source: [EPA National Primary Drinking Water Regulations](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations).
...
Check the [testing section](/testing/) for guidance on reading a CCR and understanding what the numbers mean.
...
Activated carbon filtration is the most practical starting point. Both granular activated carbon (GAC) and solid carbon block filters reduce THMs at the tap. Look for NSF/ANSI 53 certification, which covers health-based contaminant reduction, or NSF/ANSI 42 for aesthetic reduction including chlorine and some organic compounds. Carbon pitcher filters can work, see [best pitcher water filters](/treatment/best-pitcher-water-filters/), but confirm the model carries the NSF certification before buying.

Reverse osmosis is the more thorough option. An RO system at the kitchen sink reduces TTHMs along with dozens of other contaminants. Visit the [treatment section](/treatment/) for a breakdown of system types.
...
Related: [How chloramines compare as a disinfectant](/your-water/contaminants/chloramines/). Some utilities have switched from chlorine to chloramines specifically to reduce THM formation. That trade-off comes with its own byproducts worth understanding.
