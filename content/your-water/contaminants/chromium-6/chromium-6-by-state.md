---
title: "Chromium-6 in US Tap Water: Where It's Found and How High"
description: "EWG testing found chromium-6 in tap water serving 250 million Americans. California adopted a 10 ppb limit in 2024. Here's where levels are highest and what that means."
date: 2026-02-27
lastmod: 2026-02-27
primaryKeyword: "chromium-6 in tap water"
silo: "your-water"
pageType: "spoke"
layout: "spoke"
...
draft: false
faq:
  - question: 'Is there a federal limit for chromium-6 in drinking water?'
    answer: 'No federal limit specifically for chromium-6 exists. The EPA has a limit of 100 ppb for total chromium, which covers both chromium-3 (an essential nutrient) and chromium-6 (the carcinogen). The EPA has been working on a chromium-6-specific rule for years but hasn''t finalized one. California became the first state to adopt a specific chromium-6 MCL, set at 10 ppb, which took effect in 2024.'
  - question: 'What is the difference between chromium-3 and chromium-6?'
    answer: 'Chromium-3 is an essential trace mineral found in many foods. It''s considered harmless at typical dietary levels. Chromium-6 is a different oxidation state of the same element, and it''s a known carcinogen. Long-term ingestion of chromium-6 in drinking water is linked to stomach and intestinal cancers. The two forms can convert between each other in the environment, which is why regulators focus on total chromium, but the health concern is specifically about chromium-6.'
  - question: 'Does EWG''s data apply to my tap water?'
    answer: 'EWG''s database compiles utility-reported testing data. If your utility reports to the EPA''s Safe Drinking Water Information System, that data appears in EWG''s analysis. You can look up your zip code at ewg.org/tapwater to see your utility''s reported chromium levels. The data reflects your utility''s distribution system samples, not your individual tap.'
  - question: 'How does chromium-6 get into water?'
  ...
  - question: 'Does reverse osmosis remove chromium-6?'
    answer: 'Yes. RO systems certified to NSF/ANSI 58 remove chromium-6 effectively. Activated carbon alone is not reliably effective against chromium-6.'
---
...
EWG's tap water database at [ewg.org/tapwater](https://www.ewg.org/tapwater/) lets you enter your zip code and see what your utility has reported for chromium. EWG presents the data alongside their own health benchmarks, which are more stringent than EPA MCLs. Don't confuse EWG's health benchmarks with legal limits. They're different numbers with different purposes.

If your utility reports total chromium near or above 10 ppb, or if you're in an area with a history of industrial contamination, you can also get your tap water tested by a certified lab for chromium-6 specifically. See the [best mail-in water tests](/testing/best-mail-in-water-tests/) page for lab options, and the [how to read your water quality report](/learn/how-to-read-water-quality-report/) guide for help making sense of utility data.
...
- California State Water Resources Control Board, "Hexavalent Chromium (Chromium-6) Maximum Contaminant Level": [waterboards.ca.gov](https://www.waterboards.ca.gov/drinking_water/certlic/drinkingwater/Chromium6.html)
...
- California OEHHA, "Chromium Hexavalent (Chromium-6)": [oehha.ca.gov](https://oehha.ca.gov/chemicals/chromium-hexavalent)
