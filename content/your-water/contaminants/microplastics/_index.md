---
title: "Microplastics in Drinking Water: What the Research Actually Shows"
description: "Microplastics in drinking water are everywhere, but bottled water is worse than tap. Here's what the research says and what filters actually work."
date: 2026-02-22
lastmod: 2026-02-22
draft: false
primaryKeyword: "microplastics in drinking water"
silo: "your-water"
...
faq:
  ...
  - question: 'Does bottled water have more microplastics than tap water?'
    answer: 'Research suggests yes, significantly more. Studies estimate bottled water drinkers ingest roughly 90,000 additional microplastic particles per year compared to about 4,000 for tap water drinkers. The plastic bottle and cap are the primary sources. Switching to filtered tap water appears to reduce exposure rather than increase it.'
  - question: 'Do water filters remove microplastics?'
    answer: 'Reverse osmosis systems remove the vast majority of microplastics. RO membranes have pore sizes around 0.0001 microns, far smaller than even nanoplastics. High-quality solid carbon block filters with tight pore sizes can also capture many microplastics. NSF hasn''t issued a specific microplastic removal standard yet, but NSF/ANSI 58 certification (for RO systems) is currently the best benchmark to look for.'
  - question: 'Are microplastics in drinking water dangerous?'
    answer: 'The research is still early. A 2024 study in the New England Journal of Medicine found an association between microplastics in arterial plaque and higher rates of cardiovascular events, but the researchers noted the findings needed further investigation to establish causation. Other lab research links microplastics to inflammation and oxidative stress. The EPA hasn''t set a legal limit yet and classifies this as an active research area.'
  - question: 'Does boiling water remove microplastics?'
    answer: 'A 2024 study found boiling removed up to 90% of microplastics in hard water samples. The calcium carbonate scale that forms during boiling traps particles, which you then discard with the scale. The effect was smaller in soft water. This is a promising finding from one study, not a confirmed treatment method, and it doesn''t work the same way for all water types.'
---
...
Reverse osmosis is the most reliable option. RO membranes filter at 0.0001 microns, smaller than even nanoplastics. An NSF/ANSI 58 certified RO system removes the vast majority of microplastics at the point of use, along with a long list of other contaminants including [PFAS](/your-water/contaminants/pfas/) and lead.
...
For filter options, see our [best under-sink RO systems](/treatment/reverse-osmosis/best-under-sink-ro-systems/) review. If you don't know what's in your water yet, start with [water testing](/testing/) before buying any treatment system.

---

**Sources:**

- Schwabl P, et al. Detection of Various Microplastics in Human Stool. *Annals of Internal Medicine*, 2019. [PMC microplastics review](https://pmc.ncbi.nlm.nih.gov/articles/PMC12474263/)
- Microplastic removal at drinking water treatment facilities. *Nature npj Clean Water*, 2025. [Full study](https://www.nature.com/articles/s41545-025-00531-w)
