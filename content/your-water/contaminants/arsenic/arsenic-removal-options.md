---
title: "How to Remove Arsenic from Well Water: What Works and What Doesn't"
description: "Reverse osmosis and activated alumina remove arsenic. Carbon filters and softeners don't. Here's how to pick the right treatment based on your test results."
date: 2026-02-27
lastmod: 2026-02-27
primaryKeyword: "remove arsenic from well water"
silo: "your-water"
pageType: "spoke"
layout: "spoke"
...
draft: false
faq:
  - question: 'What percentage of arsenic does reverse osmosis remove?'
    answer: 'RO systems certified to NSF/ANSI 58 typically achieve 85-95%+ reduction of arsenic in controlled testing. Real-world performance depends on membrane condition, water pressure, and whether arsenic is in its oxidized form (arsenate, which RO handles well) or its reduced form (arsenite, which is harder to remove). If your water has significant iron or sulfide, pre-treatment may be needed so arsenic is in the right form before the membrane.'
  - question: 'Does a whole-house filter remove arsenic?'
    answer: 'Whole-house arsenic removal is possible with a whole-house activated alumina or point-of-entry RO system. It''s appropriate if your arsenic level is very high (above 50 ppb), you have young children bathing in the water, or you want to protect plumbing and appliances. Most households can address drinking and cooking exposure with an under-sink RO at a much lower cost.'
  - question: 'Does boiling water remove arsenic?'
    answer: 'No. Boiling concentrates arsenic by evaporating water and leaving dissolved solids behind. Never use boiling as arsenic treatment.'
  - question: 'How long does an RO membrane last for arsenic removal?'
    answer: 'Most RO membranes last 2-5 years with proper maintenance. Arsenic removal efficiency declines as the membrane ages. Check your filtered water with a TDS meter periodically. A rising TDS reading in your filtered water is a sign the membrane needs replacement. Annual testing of filtered water for arsenic is the definitive check.'
  - question: 'Is arsenic removal different for different arsenic forms?'
    answer: 'Yes. Arsenic exists in two main forms: arsenate (As V) and arsenite (As III). RO and activated alumina both remove arsenate effectively. Arsenite is more difficult. If your well has high iron or is low in dissolved oxygen, arsenite may be the dominant form. A lab that specifies arsenic speciation can tell you. In those cases, pre-oxidation with a sediment filter or aeration step before the treatment unit improves removal.'
---
...
For system options, see the [best under-sink RO systems](/treatment/reverse-osmosis/best-under-sink-ro-systems/) page.

---

## Sources

- EPA, "Arsenic in Drinking Water": [epa.gov/ground-water-and-drinking-water/basic-information-about-arsenic-drinking-water](https://www.epa.gov/ground-water-and-drinking-water/basic-information-about-arsenic-drinking-water)
- NSF International, "NSF/ANSI 58, Reverse Osmosis Drinking Water Treatment Systems": [nsf.org](https://www.nsf.org/consumer-resources/articles/reverse-osmosis-systems)
- USGS, "Arsenic and Drinking Water from Private Wells": [usgs.gov](https://www.usgs.gov/special-topics/water-science-school/science/arsenic-and-drinking-water-private-wells)
- EPA, "Technologies for Arsenic Removal from Drinking Water": [epa.gov](https://www.epa.gov/sites/default/files/2014-03/documents/arsenictreat.pdf)
