---
title: "Chloramines in Tap Water: Why Your City Switched and What It Means"
description: "Hundreds of US cities now use chloramines instead of chlorine. Learn what that means for chloramines in drinking water and how to filter them."
date: 2026-02-22
lastmod: 2026-02-22
primaryKeyword: "chloramines in drinking water"
silo: "your-water"
...
faq:
  ...
  - question: 'Does Brita filter chloramines?'
    answer: 'Standard Brita pitchers use activated carbon, which is much less effective at removing chloramines than free chlorine. Chloramine bonds are harder to break. For meaningful chloramine reduction, look for filters that specifically use catalytic carbon and carry NSF/ANSI 42 certification for chloramine reduction. A standard pitcher filter won''t do the job reliably.'
  - question: 'Are chloramines in drinking water safe?'
    answer: 'The EPA sets a Maximum Residual Disinfectant Level of 4.0 mg/L for chloramines, and the CDC notes that at levels used in drinking water, the disinfectant itself poses minimal health risk for most people. That said, chloramines are toxic to fish and must be removed for dialysis patients. Some unregulated byproducts that chloramines can form are still under active research.'
  - question: 'Do shower filters remove chloramines?'
    answer: 'Most shower filters use calcium sulfite, which works on free chlorine but is much less effective on chloramines. If you specifically want chloramine reduction in the shower, look for filters using KDF-55 media or vitamin C (ascorbic acid) and check for NSF/ANSI 177 certification that covers chloramine. Don''t assume a shower filter removes chloramines just because it removes chlorine.'
  - question: 'Why did my city switch from chlorine to chloramines?'
    answer: 'Chloramines produce fewer regulated disinfection byproducts, specifically trihalomethanes (THMs) and haloacetic acids (HAAs), than free chlorine. When the EPA tightened limits on those byproducts, many utilities switched to chloramines to stay within legal limits. Chloramines also last longer in distribution pipes, which helps maintain disinfection in large water systems.'
---
...
The CDC notes that at the concentrations used in drinking water treatment, chloramine poses minimal health risk for most people. You can read the CDC's statement directly at [cdc.gov](https://www.cdc.gov/drinking-water/about/about-water-disinfection-with-chlorine-and-chloramine.html). The EPA's chloramine drinking water regulations are at [epa.gov/dwreginfo/chloramines-drinking-water](https://www.epa.gov/dwreginfo/chloramines-drinking-water).
...
**Reverse osmosis systems** remove chloramines effectively. RO pushes water through a semi-permeable membrane that blocks most dissolved contaminants including disinfectants. If you're already considering RO for other reasons, it will handle chloramines too. See our [treatment page](/treatment/) for more on how RO works.
...
You can also read your Consumer Confidence Report (CCR). Every community water system is required to send customers an annual water quality report. It lists what disinfectant your utility uses. If it says "chloramine" or "monochloramine," you have your answer. Your [testing page](/testing/) has more on reading water quality reports and understanding what the numbers mean.
...
For byproducts like THMs that chloramine helps reduce but doesn't eliminate entirely, see our page on [disinfection byproducts](/your-water/contaminants/thms/).
