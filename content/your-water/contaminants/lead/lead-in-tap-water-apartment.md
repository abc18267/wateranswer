---
title: 'Lead in Apartment Tap Water: What Renters Need to Know'
description: 'Lead in tap water is a real risk for apartment renters in older buildings. Here''s how to test, what filters work, and what your landlord is required to tell you.'
date: 2026-02-22
lastmod: 2026-02-22
primaryKeyword: 'lead in tap water apartment'
silo: 'your-water'
pageType: 'spoke'
layout: 'spoke'
...
showDisclaimer: true
faq:
  - question: 'How do I test my apartment tap water for lead?'
    answer: 'Buy a certified lab test kit online or through your state health department. Collect a first-draw sample — water that has sat in the pipes for at least 6 hours, ideally overnight. Use the kitchen cold tap. Fill the sterile bottle with the very first water that comes out, without running the tap first. Ship it to the certified lab included with the kit. Results typically arrive in 1 to 5 business days.'
  - question: 'Is my apartment building required to have lead-free plumbing?'
    answer: 'Lead pipes and lead solder were banned for new plumbing in 1986. Buildings constructed after 1986 shouldn''t have lead solder or lead service lines. But buildings built before that date — and many built through the early 1990s using older pipe stock — may still have lead solder at joints and brass fixtures with elevated lead content. Your utility''s service line to the building may be lead-free while internal building plumbing still contributes lead at the tap.'
  - question: 'Does running the tap before drinking reduce lead exposure?'
    answer: 'Yes, meaningfully. Lead leaches into water during contact time — the longer water sits in pipes or at fixtures, the more lead it picks up. Flushing the cold tap for 30 to 60 seconds before use pushes out that stagnant water. It''s not a permanent fix, but it''s a consistent daily reduction in exposure from that tap.'
  - question: 'What pitcher filter removes lead from apartment water?'
    answer: 'Only filters certified to NSF/ANSI Standard 53 for lead reduction actually remove lead. Brita''s Longlast+ (blue filter) carries NSF 53 certification for lead. Clearly Filtered pitchers also carry NSF 53 certification and typically show higher lead removal rates in testing. Standard Brita filters (white) are not certified for lead. Always check the specific filter model''s NSF certificate before buying.'
  - question: 'Can my landlord be held liable for lead in tap water?'
    answer: 'It depends on your jurisdiction. Federal law (Title X) requires landlords to disclose known lead hazards, though it primarily targets lead paint, not plumbing. Some cities require landlords to test for or disclose lead plumbing. If a landlord knew about a lead hazard and didn''t disclose it, that can create liability under local housing codes or tenant protection laws. An attorney familiar with your local housing law can give you a specific answer.'
---
...
**Test the tap yourself.** A certified lab first-draw lead test for a single tap costs $15 to $40. You don't need your landlord's permission to test your own tap water. Collect a first-draw sample — water that has sat in the pipes overnight — and ship it to a certified lab. [How to Test Your Tap Water for Lead](/your-water/contaminants/lead/how-to-test-for-lead/) has the full protocol.
