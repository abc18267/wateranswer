...
draft: false
faq:
  - question: 'How much radon from well water ends up in indoor air?'
    answer: 'The EPA estimates that for every 10,000 pCi/L of radon in water, about 1 pCi/L enters indoor air. The inhalation risk from that airborne radon is about 100 times greater than the ingestion risk from drinking the water directly. This means a well with high radon creates a meaningful indoor air quality problem, especially in bathrooms and kitchens where water is agitated.'
  - question: 'What radon level in well water is considered high?'
    answer: 'The EPA proposed an MCL for radon in drinking water at 300 pCi/L for utilities that also implement an indoor radon reduction program, and 4,000 pCi/L without such a program. These were never finalized. As a practical reference, many state programs treat above 4,000 pCi/L in private wells as the action threshold. Contact your state radon program for local guidance.'
  - question: 'Does radon in well water affect everyone in the house?'
    answer: 'The inhalation risk affects everyone in the home, since radon released during showering and dishwashing enters the air in enclosed spaces. The drinking water ingestion risk is lower and affects only those consuming the water. Improving ventilation in bathrooms and installing point-of-entry aeration to release radon before water enters the home are the two main protective strategies.'
  - question: 'Can I test my well water for radon myself?'
    answer: 'Yes. Water radon test kits are available for home use. You collect a water sample and mail it to a laboratory. Make sure the lab is certified by your state''s radon testing program or the National Radon Proficiency Program (NRPP). Some state radon offices offer discounted testing kits. Test separately for waterborne radon and for airborne radon in your home.'
  - question: 'Does a standard water filter remove radon?'
    answer: 'Granular activated carbon (GAC) at the point of entry removes radon from water very effectively, typically 95%+. Aeration (releasing water through the air at the point of entry) also removes radon. Standard under-sink filters and pitcher filters don''t address waterborne radon because the radon has already off-gassed by the time the water reaches those filters.'
---
