---
title: "Radon in Well Water: The Risk You're More Likely to Breathe Than Drink"
description: "Radon in well water poses more risk through inhalation than ingestion. Learn who's at risk, how to test, and what treatment actually works."
date: 2026-02-22
lastmod: 2026-02-22
...
faq:
  ...
  - question: 'How do I test my well water for radon?'
    answer: 'Order a radon-in-water test from a certified lab. It''s a separate test from the radon-in-air test kits used for basements, don''t confuse the two. Most certified radon-in-water tests cost $20 to $40. Your state health department can direct you to certified labs, and many state programs offer low-cost testing for well owners.'
  - question: 'How does radon get into well water?'
    answer: 'Radon is a radioactive gas produced naturally by the decay of uranium in rock and soil. When groundwater flows through uranium-containing rock formations, especially granite, it picks up dissolved radon. Private wells that draw from deep aquifers in these rock types can have significant radon concentrations. Surface water isn''t affected because radon escapes to the atmosphere before it can accumulate.'
  - question: 'What removes radon from well water?'
    answer: 'Aeration is the most effective treatment. A point-of-entry aeration system strips dissolved radon gas from water before it enters the house, removing 95 to 99% of the radon. Granular activated carbon (GAC) filters also remove radon effectively, but the carbon accumulates radioactive decay products over time and requires special disposal. For high radon levels, aeration is generally the better choice.'
  - question: 'Does radon in water cause lung cancer?'
    answer: 'Radon from well water can contribute to lung cancer risk through inhalation, when water use releases radon gas into indoor air. The EPA estimates that waterborne radon accounts for a small fraction of total radon-related lung cancer deaths, with soil radon (entering through foundation cracks) being the much larger contributor for most homes. If your home has both high radon in air and radon in water, address the air pathway first, then the water.'
---
...
If you're working through a full well water testing plan, the [well water testing guide](/your-water/well-water/well-water-testing-guide/) covers which tests to run based on your location and well type.
