...
draft: false
faq:
  - question: 'Is manganese in drinking water dangerous?'
    answer: 'Manganese is an essential trace mineral. At low levels, it''s necessary for normal body function. But at elevated levels in drinking water, the research suggests a risk to neurological development, particularly in infants and young children. The EPA issued a health advisory for manganese of 0.3 mg/L for adults and 0.1 mg/L for infants. These are advisory levels, not enforceable MCLs, but they''re based on health data, not just aesthetics.'
  - question: 'What are the symptoms of too much manganese from water?'
    answer: 'At very high occupational exposures, manganese causes a Parkinson''s-like syndrome called manganism. The research on drinking water levels focuses on more subtle neurological effects: lower IQ scores, attention and memory problems, and motor skill differences in children with higher manganese intake. These are associations found in epidemiologic studies, not direct causation proven by clinical trials. But the pattern across multiple studies is consistent enough that the EPA issued a health advisory.'
  - question: 'Is manganese staining in well water a health risk?'
    answer: 'Staining on fixtures and laundry (brownish-black stains from manganese) indicates that manganese is present, but staining doesn''t directly tell you the concentration. The EPA Secondary MCL for manganese is 0.05 mg/L, which is the aesthetic threshold. The health advisory threshold is 0.3 mg/L for adults. Staining can occur below the health advisory level. You need a lab test for the actual concentration.'
  - question: 'Should infants drink water with manganese?'
    answer: 'The EPA health advisory for infant exposure is 0.1 mg/L, about one-third of the adult advisory level. The lower threshold reflects concern about neurological development during early childhood. If your well water tests above 0.1 mg/L for manganese and you have an infant in the home, your child''s care team should know. Filtered or bottled water for formula preparation is a reasonable precaution while you evaluate treatment options.'
  - question: 'Does my municipality test for manganese?'
    answer: 'Utilities test for manganese as part of EPA Secondary Standards compliance, but the testing frequency and reporting varies. Your Consumer Confidence Report may not specifically call out manganese unless levels are above the secondary standard. You can call your utility and ask for their manganese data for the past year. For well owners, testing is the only way to know.'
---
...
For treatment options, see [how to remove manganese from well water](/treatment/how-to-remove-manganese-from-water/). For lab testing resources, see [best mail-in water tests](/testing/best-mail-in-water-tests/).

---

**Related pages:** [Manganese in Well Water](/your-water/contaminants/manganese/) | [Well Water Testing Guide](/your-water/well-water/well-water-testing-guide/) | [Best Mail-In Water Tests](/testing/best-mail-in-water-tests/)
