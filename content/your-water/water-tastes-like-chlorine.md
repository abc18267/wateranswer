---
title: "Water Tastes Like Chlorine: Causes and Simple Fixes"
description: "Chlorine taste in tap water is normal, but that doesn't mean you have to live with it. Here's what's actually in the glass and the fastest ways to fix it."
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: "water tastes like chlorine"
silo: "your-water"
pageType: "spoke"
layout: "spoke"
...
faq:
  - question: 'Why does my tap water taste like chlorine?'
    answer: 'Your utility adds chlorine or chloramines to kill bacteria in the distribution system. The EPA allows up to 4 mg/L of chlorine in tap water, but most people can taste it at concentrations as low as 0.2 to 0.5 mg/L. So the taste often kicks in well below the legal limit. It''s not a sign your water is unsafe. It means disinfection is working.'
  - question: 'Is chlorine in tap water safe to drink?'
    answer: 'Yes, at the concentrations used in US municipal water. The EPA maximum for free chlorine is 4 mg/L, and typical tap water runs 0.2 to 1.0 mg/L. Long-term exposure at those levels has not been shown to cause harm. The disinfection byproducts that form when chlorine reacts with organic matter in water are a separate concern, but they involve different compounds than the chlorine taste itself.'
  - question: 'Does a Brita filter remove chlorine taste?'
    answer: 'Yes, a standard Brita pitcher filter with activated carbon removes free chlorine and improves taste noticeably. It''s one of the most cost-effective fixes for chlorine taste. However, if your utility uses chloramines instead of chlorine, a standard Brita is less effective. Chloramines require catalytic carbon or a longer carbon contact time to reduce significantly.'
  - question: 'What''s the difference between chlorine and chloramine taste?'
    answer: 'Free chlorine has a sharper, more familiar "pool water" taste and smell. Chloramines have a more medicinal or slightly bitter quality, sometimes described as a bandage or antiseptic smell. If your water''s taste doesn''t go away after the water sits uncovered in the fridge for an hour, your utility likely uses chloramines. Chlorine volatilizes. Chloramines don''t.'
  - question: 'Will the chlorine taste go away if I let water sit?'
    answer: 'If your utility uses free chlorine, yes. Chlorine is volatile and will off-gas from an uncovered container left in the fridge for 30 to 60 minutes. The taste and smell often disappear entirely. If the taste persists after an hour, your utility almost certainly uses chloramines, which don''t off-gas the same way. You''ll need a filter designed for chloramine removal.'
---
...
To find out which your utility uses, check their annual Consumer Confidence Report, which they're required to mail or post online every year. It will list the disinfectant type. You can also call them directly and ask. Learn more about [chloramines and what they mean for home filtration](/your-water/contaminants/chloramines/).
