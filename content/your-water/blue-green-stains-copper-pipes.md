---
title: "Blue-Green Stains on Fixtures: What Your Pipes Are Telling You"
description: "Blue or green stains on faucets, drains, and tubs mean copper is leaching from your pipes. Here's when that's a minor annoyance and when it warrants testing."
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: "blue green stains on fixtures water"
silo: "your-water"
pageType: "spoke"
layout: "spoke"
...
showDisclaimer: true
faq:
  - question: 'What causes blue-green stains in a bathroom sink?'
    answer: 'Blue-green stains are basic copper carbonate, the byproduct of copper pipe corrosion. When water is acidic (pH below 7.0) or has low alkalinity, it reacts with copper plumbing. The corroded copper deposits on fixtures wherever water contacts a surface and then dries, leaving behind that characteristic blue-green tint. Soft water from low-mineral geology accelerates the process.'
  - question: 'Is copper in tap water dangerous?'
    answer: 'At low levels, no. Copper is an essential nutrient and is safe at concentrations found in most homes. The EPA action level is 1.3 mg/L at the tap. Above that level, utilities are required to take corrective action. Short-term exposure to elevated copper can cause nausea, vomiting, and stomach cramps. Children and people with Wilson''s disease, a copper metabolism disorder, are more sensitive and should test their water if staining is heavy or persistent.'
  - question: 'How do I stop copper stains on my tub?'
    answer: 'Removing stains without fixing the source is a temporary measure. For the stains themselves, a paste of Bar Keepers Friend or a commercial product like CLR applied directly works well. To stop new staining, you need to address the cause. If your water is acidic, a calcite neutralizing filter raises pH and reduces corrosion. A certified plumber can assess whether the pipe condition warrants more significant action.'
  - question: 'Does low pH cause copper pipe corrosion?'
    answer: 'Yes. Water with a pH below 7.0 is corrosive to copper. The lower the pH, the more aggressive the attack on copper pipes. Private wells in areas with granitic bedrock, such as parts of New England, the Appalachians, and the Pacific Northwest, often produce naturally acidic water. Some municipal supplies are also slightly acidic. A basic home test strip can check your pH in minutes.'
  - question: 'What water filter removes copper?'
    answer: 'An NSF/ANSI 53 certified filter is required for copper reduction at the drinking tap. Standard carbon block filters and pitcher filters that are only NSF 42 certified don''t reliably remove dissolved copper. A calcite neutralizing filter installed at point of entry addresses the root cause by raising pH, which reduces how much copper the water picks up from pipes in the first place. Point-of-use NSF 53 filters handle what reaches the tap.'
---
...
One more thing: if your home has older plumbing, corrosive water that attacks copper pipes may also be leaching lead from solder joints or from any lead-containing fixtures. The same water chemistry that causes blue-green staining can increase lead levels at the tap. See [lead in tap water](/your-water/contaminants/lead/) for when to test and what to do.
