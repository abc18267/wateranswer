---
title: "EPA MCL vs. MCLG: What the Two Water Quality Standards Actually Mean"
description: "EPA MCL and MCLG sound similar but mean very different things. Understanding the gap between them changes how you read any water quality report."
date: 2026-02-22
lastmod: 2026-02-22
primaryKeyword: "EPA MCL vs MCLG"
silo: "learn"
pageType: "spoke"
layout: "spoke"
...
Water utilities must meet the MCL. If they don't, they're in violation of the Safe Drinking Water Act and must notify customers and take corrective action. The MCL is what shows up in your [Consumer Confidence Report](/learn/how-to-read-water-quality-report/) as the legal standard your utility is measured against.
...
[Arsenic](/your-water/contaminants/arsenic/) has an MCLG of 0 and an MCL of 10 ppb. The EPA classifies arsenic as a known human carcinogen based on bladder and lung cancer data. Getting drinking water arsenic to zero isn't achievable with current treatment at reasonable cost. So the MCL was set at 10 ppb — a number the EPA estimated would reduce cancer risk substantially while remaining technically achievable.

[PFOA and PFOS](/your-water/contaminants/pfas/) have MCLGs of 0 under the EPA's April 2024 final rule. The MCLs are set at 4 parts per trillion — the lowest level that can be reliably measured and confirmed with current laboratory methods. The MCL literally couldn't go lower given today's detection technology.
...
[Lead](/your-water/contaminants/lead/) is different, and worth its own explanation.
...
This distinction matters especially in older housing stock. The [CDC says no safe blood lead level in children has been identified](https://www.cdc.gov/nceh/lead/). The regulatory structure for lead in water reflects treatment-side limitations, not a scientific finding that 14 ppb is harmless.
...
For contaminants that matter most, read the dedicated pages: [PFAS](/your-water/contaminants/pfas/), [lead](/your-water/contaminants/lead/), and [arsenic](/your-water/contaminants/arsenic/) all have detailed breakdowns of what the research says at real-world exposure levels.

---

*Sources: [EPA: How EPA Regulates Drinking Water Contaminants](https://www.epa.gov/sdwa/how-epa-regulates-drinking-water-contaminants) | [EPA National Primary Drinking Water Regulations](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations) | [EWG Health Standards](https://www.ewg.org/tapwater/ewg-standards.php)*
