---
title: "How to Read Your Water Quality Report (CCR)"
description: "Your utility mails you a Consumer Confidence Report every year. Most people ignore it. Here's how to read it and what to actually watch for."
date: 2026-02-22
lastmod: 2026-02-22
primaryKeyword: "consumer confidence report"
silo: "learn"
pageType: "spoke"
layout: "spoke"
...
faq:
  - question: 'What is a Consumer Confidence Report?'
    answer: 'A Consumer Confidence Report (CCR) is an annual water quality report that every public water system in the US must send its customers by July 1 each year. It lists every regulated contaminant detected that year, the levels found, and how they compare to EPA limits. Private well owners don''t receive one — they''re responsible for testing their own water.'
  - question: 'Where can I find my Consumer Confidence Report online?'
    answer: 'Most utilities post it on their website. The EPA maintains a database of reports at epa.gov/ccr, where you can search by state or system name. EWG''s Tap Water Database at ewg.org/tapwater/ is often easier — search by zip code and it pulls data from your utility''s reports and adds EWG''s own health benchmarks.'
  - question: 'What''s the difference between MCL and MCLG in a water report?'
    answer: 'The MCLG (Maximum Contaminant Level Goal) is the EPA''s health target — the level at which no known health effects occur. The MCL (Maximum Contaminant Level) is the legal limit that utilities must actually meet. For carcinogens, the MCLG is typically zero, but the MCL is set higher because getting to zero isn''t technically feasible. Levels below the MCL are legal, but not necessarily risk-free.'
  - question: 'What should I do if my utility had a violation?'
    answer: 'A health-based violation means a contaminant exceeded the legal limit. Your utility is required to notify you and tell you what steps to take. Don''t wait for that guidance — switch to bottled water or a certified filter immediately. A monitoring violation (missed testing) is less urgent but still worth following up on. Call your utility directly and ask what happened.'
  - question: 'Does the Consumer Confidence Report show lead levels in my water?'
    answer: 'Not exactly. Lead enters water from household pipes and plumbing fixtures, not the source water itself. Your utility tests lead at a sample of customer taps, not at every home. If you have lead pipes, old solder, or brass fixtures, your actual tap water lead level could be higher than what the report reflects. The only way to know for sure is to test your tap directly.'
---
...
Your utility's website almost always posts it. Search "[your city] water quality report [year]". The EPA also maintains a database at [epa.gov/ccr](https://www.epa.gov/ccr), searchable by state and utility name.

The easiest starting point for most people is [EWG's Tap Water Database](https://www.ewg.org/tapwater/). Search by zip code. It pulls data from your utility's reports and lets you see it alongside EWG's own health benchmarks. More on the difference between those benchmarks and EPA limits in a moment.
...
This distinction matters most for carcinogens. Arsenic, benzene, [PFAS](/your-water/contaminants/pfas/), [lead](/your-water/contaminants/lead/) — all have MCLGs at or near zero. Staying below the MCL satisfies the law. It doesn't guarantee no risk.
...
Private wells. If your home uses a private well, no CCR exists for your water. You're responsible for testing it yourself. The [testing section](/testing/) has guidance on what to test for and how.

Lead at the tap. [Lead](/your-water/contaminants/lead/) doesn't come from your utility's source water — it comes from pipes and plumbing inside your home. Your utility samples lead at a set of test taps around the system, but that number doesn't reflect what comes out of your specific faucet. If your home was built before 1986, if you have lead service lines, or if you have older brass fixtures, test your tap directly.

Unregulated contaminants. The CCR only covers contaminants the EPA requires utilities to test for. PFAS compounds, for example, weren't in most reports until the 2024 EPA rule required testing. There are chemicals in use today that utilities aren't required to test for. [PFAS](/your-water/contaminants/pfas/) and [THMs](/your-water/contaminants/thms/) are two categories worth reading up on separately.
...
If you want to go deeper than the CCR, [get your water tested directly](/testing/). A lab test of your tap water captures what the CCR misses — including lead at the tap and some unregulated contaminants.

---

*Sources: [EPA Consumer Confidence Reports](https://www.epa.gov/ccr) | [EWG Tap Water Database](https://www.ewg.org/tapwater/) | [CDC: How to Read Your Drinking Water Quality Report](https://www.cdc.gov/drinking-water/about/how-to-read-drinking-water-quality-reports.html)*
