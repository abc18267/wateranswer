---
title: 'Nitrates in Midwest Well Water: The Agricultural Runoff Problem'
description: 'Iowa, Illinois, Indiana, Nebraska, and Kansas have some of the highest nitrate levels in groundwater in the US. Here''s why, who''s at risk, and what to do about it.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'midwest nitrates well water'
silo: 'learn'
pageType: 'spoke'
layout: 'spoke'
...
See our [reverse osmosis system reviews](/treatment/reverse-osmosis/best-under-sink-ro-systems/) and our [mail-in water test reviews](/testing/best-mail-in-water-tests/) for specific product recommendations.
...
A nitrate test from a certified lab costs $10-20 on its own. A basic well water panel that includes nitrates, bacteria, hardness, and pH runs $75-150 at most certified labs. Your state health department can refer you to a certified lab. See our [well water testing guide](/your-water/well-water/well-water-testing-guide/) for the full process.

The full [nitrates contaminant page](/your-water/contaminants/nitrates/) has more detail on the health science and treatment options.
