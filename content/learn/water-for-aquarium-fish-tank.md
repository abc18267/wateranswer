---
title: "Water for Aquariums: What Fish Actually Need and What Will Kill Them"
description: "Tap water has chlorine and chloramines that are toxic to fish. Here's what to remove, what to add back, and when RO is necessary versus overkill."
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: "water for aquarium fish tank"
silo: "learn"
pageType: "spoke"
layout: "spoke"
...
faq:
  - question: 'Can I use tap water for my fish tank?'
    answer: 'Yes, but not untreated. Tap water must be dechlorinated before adding to a tank. If your utility uses chloramines (about half of US systems), you need a dechlorinator that specifically neutralizes chloramines, not just chlorine. Sodium thiosulfate (the cheapest dechlorinator) handles chlorine but not chloramines. Products like Seachem Prime handle both and also detoxify ammonia.'
  - question: 'Does chlorine in tap water kill fish?'
    answer: 'Yes. Even at tap concentrations (typically 0.5-2 mg/L), chlorine damages fish gill tissue and disrupts their ability to regulate water and ion balance. Direct addition of untreated tap water to a tank can kill fish within minutes to hours depending on the species and concentration. Always dechlorinate before adding water.'
  - question: 'What''s the difference between chlorine and chloramine for aquariums?'
    answer: 'Chlorine is a standalone disinfectant that off-gasses when water is aerated or sits for 24-48 hours. Chloramine is a compound of chlorine and ammonia. It doesn''t off-gas, it stays in the water until chemically neutralized. You need a dechlorinator that lists chloramine removal on the label. Many basic dechlorinators only address chlorine. Check your water utility''s consumer confidence report to find out which disinfectant they use.'
  - question: 'Do I need RO water for a fish tank?'
    answer: 'Most community freshwater tanks work fine with properly dechlorinated tap water. RO becomes necessary when your tap water parameters don''t match your fish''s requirements. Planted tanks requiring soft, acidic water, sensitive species like discus, and reef tanks all benefit from RO. The advantage of RO is that you start with a blank slate (near-zero TDS) and add back exactly the minerals your specific fish need.'
  - question: 'How do I dechlorinate tap water for fish?'
    answer: 'Add a liquid dechlorinator to the new water before adding it to the tank, or dose the tank directly according to the product instructions. For chlorine only, sodium thiosulfate works and is cheap. For chloramine, use a complete dechlorinator like Seachem Prime, API Stress Coat, or similar products that state chloramine neutralization. Dose based on the full tank volume, not just the water being added, for safety.'
---
