...
An [NSF/ANSI 58-certified reverse osmosis system](/treatment/reverse-osmosis/best-under-sink-ro-systems/) removes 90-99% of PFOA and PFOS per independent testing. The certification requires documented reduction rates, not just a marketing claim.
...
The [EWG Tap Water Database](https://www.ewg.org/tapwater/) is the most accessible tool for consumers. Enter your zip code to see what your utility has detected and at what levels. It pulls from utility monitoring data that systems are required to submit.
...
Your annual Consumer Confidence Report (CCR) will report PFAS if detected above reporting thresholds. See [how to read your water quality report](/learn/how-to-read-water-quality-report/) for guidance on finding your CCR and understanding the numbers.

If your utility has detected PFAS at any level, an NSF 58-certified RO or NSF P473-certified filter gives you documented protection now, regardless of where your utility is on the compliance timeline. Read the [full PFAS contaminant guide](/your-water/contaminants/pfas/) and the [PFAS removal how-to](/treatment/how-to-remove-pfas/) for more on specific treatment options.
