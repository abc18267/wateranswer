---
title: "Why CPAP Machines Require Distilled Water (and What to Use Instead)"
description: "CPAP manufacturers specify distilled water for a reason. Filtered tap water isn't an equivalent substitute. Here's the actual difference and what happens if you skip it."
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: "distilled water CPAP machine"
silo: "learn"
pageType: "spoke"
layout: "spoke"
...
showDisclaimer: true
faq:
  - question: 'Why does CPAP need distilled water?'
    answer: 'CPAP humidifiers heat water. As the water evaporates, dissolved minerals in tap water stay behind and build up on the chamber walls and in the tubing. This mineral scale is hard to remove and creates surfaces where bacteria and mold can attach. Distilled water has essentially zero dissolved solids, so no mineral residue accumulates. That''s the practical reason manufacturers specify it.'
  - question: 'Can I use filtered water in my CPAP?'
    answer: 'Standard carbon-filtered water (pitcher filter, faucet filter) still contains dissolved minerals. It''s better than unfiltered tap for taste reasons, but it doesn''t prevent mineral buildup in your CPAP chamber. Reverse osmosis water (TDS under 10 mg/L) is much closer to distilled and works well in practice for many CPAP users, though it''s not what the manufacturer specifies. Distilled water from a grocery store is the manufacturer-recommended option.'
  - question: 'What happens if you use tap water in a CPAP?'
    answer: 'Two things happen. First, mineral deposits accumulate in the humidifier chamber and tubing. These deposits are hard to clean fully and shorten the life of your equipment. Second, the mineral scale creates surfaces where bacteria and mold can establish. Over time, tap water use leads to more frequent chamber fouling, potential respiratory irritation, and the need to replace components earlier than with distilled water.'
  - question: 'Is RO water okay for CPAP?'
    answer: 'Reverse osmosis water (TDS under 10 mg/L) is much closer to distilled than standard tap water and works well for many CPAP users in practice. It''s not what the manufacturer specifies, so technically your warranty may not cover mineral damage. But for users who produce their own RO water at home, it''s a reasonable daily option. Standard filtered water from a pitcher or faucet filter is not equivalent.'
  - question: 'Where do I get distilled water for CPAP?'
    answer: 'Most grocery stores carry distilled water in 1-gallon jugs for $1-2. Home Depot, Walmart, and many pharmacies also carry it. If you use your CPAP nightly with a humidifier at about 1 liter per night, that''s roughly one 1-gallon jug every 3-4 nights, or $10-15 per month. A countertop water distiller ($80-200) produces distilled water at home for about $0.05-0.10 per gallon if you want a home production option.'
---
