...
description: "Activated carbon reduces most VOCs. NSF/ANSI 53 certification tells you which compounds a specific filter has been tested for. Here's how to choose and verify."
date: 2026-02-27
lastmod: 2026-02-27
primaryKeyword: "how to remove VOCs from water"
silo: "treatment"
pageType: "howto"
layout: "howto"
...
draft: false
steps:
  - name: 'Test your water for VOCs'
    text: 'Get a certified lab test that includes a VOC panel. Standard water tests don''t always include VOCs. Request testing for common compounds like benzene, trichloroethylene (TCE), and tetrachloroethylene (PCE).'
  - name: 'Choose an activated carbon filter'
    text: 'Activated carbon is the primary treatment for VOCs. Look for a filter certified to NSF/ANSI 53 with the specific VOC compounds listed in its certification scope. Not all carbon filters are certified for the same compounds.'
  - name: 'Decide point-of-use or whole-house'
    text: 'An under-sink carbon block filter covers drinking and cooking water. A whole-house carbon system treats every tap, including showers, which matters because some VOCs are volatile and can be inhaled during showering.'
  - name: 'Test after installation and replace filters on schedule'
    text: 'Test the filtered water to confirm VOC levels are below EPA limits. Carbon filters lose effectiveness as the media becomes saturated. Replace on the manufacturer''s schedule, and test annually to verify performance.'
faq:
  - question: 'Does reverse osmosis remove VOCs?'
    answer: 'Partially. RO membranes are most effective at removing ionic contaminants (metals, nitrates, fluoride). Smaller, uncharged VOC molecules can pass through RO membranes to some extent, though most RO systems include a carbon pre-filter or post-filter that adsorbs VOCs. An RO system with carbon filtration provides better VOC coverage than the RO membrane alone.'
  - question: 'What NSF certification covers VOC removal?'
    answer: 'NSF/ANSI 53 covers health effects contaminants including specific VOCs. When you look up a filter in the NSF product database, you''ll see a list of contaminants the filter is certified to reduce. That list is specific to the model. "NSF 53 certified" on a box doesn''t mean the filter has been tested for every VOC. Check which VOCs appear on the certification list for the specific model you''re considering.'
  - question: 'Will a whole-house carbon filter remove all VOCs?'
    answer: 'A properly sized whole-house granular activated carbon (GAC) filter reduces most VOCs if they''re present at typical groundwater concentrations. Sizing matters, because contact time between water and carbon determines effectiveness. Too fast a flow rate or an undersized unit reduces effectiveness. A water treatment professional can size the system based on your VOC test results and your household flow rate.'
  - question: 'How long does a carbon filter last for VOC removal?'
    answer: 'The carbon media in a whole-house GAC filter typically needs replacement every 1-3 years, depending on your water quality and VOC levels. Higher VOC concentrations exhaust the carbon faster. Point-of-use carbon block filters (under-sink or pitcher) need more frequent replacement, typically every 3-6 months. An annual test of your filtered water is the reliable way to confirm the filter is still working.'
  - question: 'Do I need to filter for VOCs in my shower?'
    answer: 'Some VOCs are volatile enough to off-gas from shower water into the air you breathe. For people with confirmed high levels of specific VOCs (particularly benzene, toluene, or chloroform), inhalation during showering is a real exposure pathway. A whole-house carbon filter addresses this better than a point-of-use kitchen filter. If you only have an under-sink filter, your shower exposure isn''t reduced.'
---
...
See [best whole-house water filters](/treatment/best-whole-house-water-filters/) for whole-house carbon options, and [best under-sink water filters](/treatment/best-under-sink-water-filters/) for point-of-use carbon and RO systems.
...
**Related pages:** [VOCs in Drinking Water](/your-water/contaminants/vocs/) | [Best Whole-House Water Filters](/treatment/best-whole-house-water-filters/) | [Best Under-Sink Water Filters](/treatment/best-under-sink-water-filters/) | [Best Mail-In Water Tests](/testing/best-mail-in-water-tests/)
