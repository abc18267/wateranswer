...
description: "Rotten egg smell in well water comes from hydrogen sulfide. Match the fix to the source: anode rod swap, aeration, or chlorination. Step-by-step guide."
date: 2026-02-27
lastmod: 2026-02-27
primaryKeyword: "how to remove hydrogen sulfide from well water"
silo: "treatment"
pageType: "howto"
layout: "howto"
...
faq:
  ...
  - question: 'Is hydrogen sulfide in well water dangerous?'
    answer: 'At concentrations found in residential wells, hydrogen sulfide is an aesthetic problem, not a health hazard. The EPA has no health-based MCL for H2S in drinking water. The smell is the issue, not toxicity. That said, very high concentrations in confined spaces can be hazardous, but tap water concentrations are far below those levels.'
  - question: 'Will a Brita filter remove rotten egg smell?'
    answer: 'For low-level hydrogen sulfide, activated carbon in a pitcher filter can reduce the smell. But pitcher filters aren''t designed for moderate or high H2S levels. If the smell is strong or the concentration is above 0.1 mg/L, you need a whole-house aeration or chlorination system rather than a point-of-use carbon filter.'
  - question: 'Why does only my hot water smell like rotten eggs?'
    answer: 'When only the hot water smells, the source is your water heater, not your well. Magnesium anode rods inside most tank water heaters react with sulfates in the water to produce hydrogen sulfide gas. The fix is replacing the magnesium anode with an aluminum/zinc combination anode. This eliminates the reaction. It''s not a well contamination issue.'
  - question: 'Does chlorination remove hydrogen sulfide?'
    answer: 'Yes. Continuous chlorination oxidizes hydrogen sulfide into solid sulfur particles, which are then filtered out. This approach is used for high H2S levels or when iron bacteria are confirmed as the source. The water must pass through a contact tank to allow the reaction to complete, then through a carbon filter to remove residual chlorine and any remaining odor. It''s a whole-house solution, not a point-of-use one.'
---

*Affiliate disclosure: This page contains affiliate links. If you buy a product through one of these links, WaterAnswer may earn a commission at no extra cost to you. Products are recommended based on treatment effectiveness, not commission rates.*

The first question to answer isn't what product to buy. It's which tap smells.
...
If you also have iron bacteria in your well (orange-brown slime in the toilet tank), the sulfur smell may be coming from those bacteria rather than from geological H2S. Shock chlorination is the first step when bacteria are confirmed. See [how to shock chlorinate a well](/your-water/well-water/how-to-shock-chlorinate-well/) for the procedure.

For testing options, see [best mail-in water tests](/testing/best-mail-in-water-tests/).
...
- [Hydrogen sulfide in well water](/your-water/contaminants/hydrogen-sulfide/), full contaminant overview and source diagnosis
- [Hot water smells like rotten eggs](/your-water/hot-water-smells-like-rotten-eggs/), symptom diagnostic guide
- [Best whole-house water filters](/treatment/best-whole-house-water-filters/), whole-house filter options including oxidizing filters
- [Well water testing guide](/your-water/well-water/well-water-testing-guide/), what tests to order and how to read the results

*Sources: [EPA Secondary Drinking Water Standards](https://www.epa.gov/sdwa/secondary-drinking-water-standards-guidance-nuisance-chemicals) | [EPA Private Wells Contaminant Guide](https://www.epa.gov/privatewells/potential-well-water-contaminants-and-their-impacts)*
