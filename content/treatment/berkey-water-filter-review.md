...
If you have confirmed [PFAS contamination](/your-water/contaminants/pfas/) in your water, an NSF P473-certified reverse osmosis system gives you documented, independently verified removal rates. That's a stronger evidentiary standard than what Berkey provides.
...
But if you need certified PFAS removal, an NSF-certified RO system is the right call. AquaTru (NSF P473 certified) handles PFAS removal in a countertop format with no plumbing. An [under-sink RO system](/treatment/reverse-osmosis/best-under-sink-ro-systems/) gives you higher volume with the same documented removal rates.

If you're comparing Berkey against a standard [pitcher filter](/treatment/best-pitcher-water-filters/), Berkey is more capable by volume and filter life. But Clearly Filtered gives you NSF-certified PFAS and fluoride removal in a format that's easier to use daily.

For understanding what NSF certification actually means and why it matters, the [NSF certification standards explainer](/learn/nsf-certification-standards-explained/) covers each standard in plain language.
