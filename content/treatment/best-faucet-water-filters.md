---
title: 'Best Faucet Water Filters: No-Install Lead and Chlorine Protection'
description: 'Faucet-mount filters screw onto most standard faucets in under a minute. NSF 53 models remove lead and cysts on demand. Here''s how PUR, Brita, and DuPont compare.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'best faucet water filters'
silo: 'treatment'
pageType: 'review'
layout: 'review'
...
faq:
  - question: 'Do faucet water filters remove lead?'
    answer: 'Some do, some don''t. NSF/ANSI 53 certification is the only way to know for sure. PUR PLUS (PFM400H), Brita On Tap, and DuPont WFFM350XCH are all NSF 53 certified for lead reduction. A Brita Basic (FF-100) or Culligan FM-15A is certified only under NSF 42 for taste and odor. NSF 42 alone does not mean the filter removes lead. Always check the specific certification, not just the brand.'
  - question: 'Will a faucet filter fit my faucet?'
    answer: 'Faucet filters fit most traditional fixed-spout kitchen faucets with a standard aerator thread. They don''t fit pull-out faucets, pull-down faucets, or side-spray faucets. They also won''t work on faucets with non-standard aerator sizes. Most units come with multiple adapter rings to cover common thread sizes. If you''re not sure, check the faucet manufacturer''s aerator spec before ordering.'
  - question: 'How long does a faucet filter last?'
    answer: 'PUR and Brita faucet filters are typically rated at 100 gallons per cartridge, which works out to roughly 3 months for average household use. The PUR PLUS has a digital indicator light that tells you when to replace it. Brita faucet models use a manual indicator tab. Replace on schedule. Running an expired filter doesn''t just mean reduced performance, it can release trapped contaminants back into the water.'
  - question: 'Is a faucet filter better than a pitcher?'
    answer: 'For convenience, yes. A faucet filter delivers filtered water on demand without pouring. For contaminant coverage, it depends. A PUR PLUS faucet filter and a Clearly Filtered pitcher are both NSF 53 certified, so lead coverage is comparable. But Clearly Filtered pitchers cover PFAS and fluoride, no faucet filter on the market covers both. If PFAS or fluoride is a concern, a pitcher like Clearly Filtered or a reverse osmosis system is the better choice.'
  - question: 'Does PUR faucet filter remove PFAS?'
    answer: 'No. PUR faucet filters are not certified or documented to remove PFAS. PUR holds NSF/ANSI 42 and 53 certifications, which cover chlorine, lead, benzene, mercury, cysts, and other specific contaminants. PFAS removal requires either an NSF 58 certified reverse osmosis system or a filter like Clearly Filtered that has been independently tested for PFAS reduction. For PFAS, a faucet filter won''t help.'
---
...
They don't remove PFAS. No faucet filter on the market is certified or documented to remove PFAS at meaningful levels. For [PFAS](/your-water/contaminants/pfas/), you need a Clearly Filtered pitcher or a reverse osmosis system.
...
If you have a pull-out or pull-down faucet, which covers most modern kitchen faucet designs, a faucet filter won't work. In that case, look at a pitcher filter or a dedicated [under-sink filter](/treatment/best-under-sink-water-filters/).
...
If you need something that goes beyond what any faucet filter can do, read the [under-sink filter comparison](/treatment/best-under-sink-water-filters/) or the [reverse osmosis system review](/treatment/reverse-osmosis/best-under-sink-ro-systems/). A faucet filter is the right solution for renters who want lead and chlorine protection at one faucet. It's not the right solution for PFAS, fluoride, or whole-house protection.
