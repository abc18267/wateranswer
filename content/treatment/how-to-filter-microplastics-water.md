...
description: 'RO membranes physically block microplastics. Carbon block filters reduce them. Regular activated carbon granules largely don''t. Here''s what the research shows about which filters work.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'how to filter microplastics from water'
silo: 'treatment'
pageType: 'howto'
layout: 'howto'
...
RO also removes PFAS, lead, fluoride, nitrates, arsenic, and a range of other contaminants. If microplastic reduction is one of several reasons you're considering a filter, RO addresses all of them with a single system. See [the best under-sink RO systems](/treatment/reverse-osmosis/best-under-sink-ro-systems/).
...
For help matching your water quality to the right filter type, see [what water filter do I need](/treatment/what-water-filter-do-i-need/) and the [microplastics in drinking water overview](/your-water/contaminants/microplastics/).
