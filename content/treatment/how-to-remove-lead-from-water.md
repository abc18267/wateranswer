...
lastmod: 2026-02-27
draft: false
primaryKeyword: "how to remove lead from tap water"
silo: "treatment"
pageType: "howto"
layout: "howto"
...
faq:
  ...
  - question: 'Does a Brita filter remove lead?'
    answer: 'Standard Brita pitchers using the Basic filter cartridge are not certified to remove lead. The Brita Longlast filter IS certified to NSF/ANSI 53 for lead reduction. Before relying on any pitcher filter for lead, look up the specific model and cartridge in the NSF product database at info.nsf.org to confirm the certification. Do not assume based on brand name.'
  - question: 'What is the best filter for lead in water?'
    answer: 'Reverse osmosis systems certified to NSF/ANSI 58 are the most reliable option. They remove 97 to 99% of dissolved lead. For a simpler solution at the kitchen tap, a solid carbon block filter certified to NSF/ANSI 53 specifically for lead reduction also works well. Point-of-use treatment at the kitchen tap is more effective than whole-house filtration for lead, since lead enters the water at plumbing fixtures and service lines, not at the treatment plant.'
  - question: 'Does a water softener remove lead?'
    answer: 'No. Water softeners use ion exchange to remove calcium and magnesium, not lead. Lead is a different class of contaminant. A softener does nothing for lead. You need a filter certified to NSF 53 or NSF 58.'
  - question: 'How do I know if my filter is removing lead?'
    answer: 'The only reliable way is to verify the filter has current NSF/ANSI 53 or NSF 58 certification for lead at the NSF product database (info.nsf.org). NSF testing verifies the filter reduces lead by the claimed amount under standardized test conditions. Marketing language like "tested for lead reduction" or "reduces up to 99% of contaminants" without citing a specific NSF certification number is not a substitute for actual certification.'
---
...
For the full testing walkthrough, see [how to test for lead in water](/your-water/contaminants/lead/how-to-test-for-lead/).
...
1. Go to the NSF product search at info.nsf.org/Certified/DWTU/
2. Search by brand name or model
3. Confirm the specific cartridge is listed
4. Confirm it shows NSF/ANSI 53 (for carbon) or NSF/ANSI 58 (for RO)
5. Check the "contaminant reduction claims" to confirm lead is listed
...
- [Best under-sink RO systems](/treatment/reverse-osmosis/best-under-sink-ro-systems), top NSF 58-certified options
- [Best pitcher water filters](/treatment/best-pitcher-water-filters), which pitchers are actually certified for lead

For more on lead in plumbing and who's most at risk, see [lead in drinking water](/your-water/contaminants/lead/).
...
*Sources: [EPA Lead in Drinking Water](https://www.epa.gov/ground-water-and-drinking-water/basic-information-about-lead-drinking-water) | [NSF/ANSI 53](https://www.nsf.org/testing/water/water-treatment-systems/drinking-water-treatment-units-health-effects-nsf-ansi-53) | [NSF Product Search](https://info.nsf.org/Certified/DWTU/)*
