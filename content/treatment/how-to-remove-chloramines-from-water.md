...
description: "Standard carbon filters don't reliably remove chloramines. Catalytic carbon does. Here's what to buy, what certifications to check, and what won't work."
date: 2026-02-27
lastmod: 2026-02-27
primaryKeyword: "how to remove chloramines from water"
silo: "treatment"
pageType: "howto"
layout: "howto"
...
faq:
  ...
  - question: 'Does vitamin C remove chloramine from drinking water?'
    answer: 'Vitamin C (ascorbic acid) neutralizes chloramine on contact and is very effective. It''s the preferred method for filling fish tanks and pools when you don''t have a carbon filter. For household drinking water, a catalytic carbon filter is more practical than dosing with vitamin C continuously. Vitamin C is commonly used in shower filters designed for chloramine removal.'
  - question: 'Can I remove chloramines from shower water?'
    answer: 'Yes, but you need the right filter. Most shower filters use calcium sulfite, which removes free chlorine but is much less effective on chloramine. For shower chloramine reduction, look for filters using KDF-55 media or vitamin C (ascorbic acid) cartridges. Some filters combine both. Check the product''s NSF/ANSI 177 certification and confirm it lists chloramine removal, not just general chlorine.'
  - question: 'Will leaving water out overnight remove chloramines?'
    answer: 'No. Free chlorine off-gasses when you let water sit in an open container. Chloramine doesn''t, at least not meaningfully within 24 hours. Don''t rely on this method if your utility uses chloramines.'
  - question: 'How do I know if my filter is working on chloramines?'
    answer: 'The most reliable method is a water test. A chloramine test kit or test strip can measure residual chloramine in your filtered water. The result should be near zero if your filter is working. Drop-based test kits (the kind used for pool water) are reasonably accurate for this purpose. Retest every few months and after filter changes.'
---

*Disclosure: This page contains affiliate links. We may earn a commission if you purchase through them, at no extra cost to you. We only recommend products we've researched and believe are worth considering. See our [review policy](/review-policy/) for details.*

Your utility switched to chloramines to reduce THMs. Now the problem is that the filter you already own might not work on it. This is a real issue, and most filter marketing doesn't make the distinction clear.
...
Our [guide to reading your Consumer Confidence Report](/learn/how-to-read-water-quality-report/) explains where to find the disinfectant information.
...
Our [best shower filters page](/treatment/best-shower-filters/) covers options with documented chloramine reduction separately from those that only handle free chlorine.
