...
faq:
  - question: 'What happens if you use a water filter past its replacement date?'
    answer: 'An expired filter stops removing contaminants effectively. Worse, a saturated carbon filter can release trapped contaminants back into your water, called "dumping", if it becomes overloaded. Bacteria can also grow in a wet, saturated filter over time. You may be drinking water that''s worse than unfiltered.'
  - question: 'How often should I replace a Brita filter?'
    answer: 'Brita''s standard pitcher filter should be replaced every 40 gallons or 2 months, whichever comes first. The Brita Longlast filter lasts 120 gallons or 6 months. These estimates assume average tap water quality, harder water or higher chlorine levels can shorten filter life. The indicator light on Brita pitchers tracks usage, but it measures time, not actual gallons filtered.'
  - question: 'How long do RO filters last?'
    answer: 'A reverse osmosis system typically has 3, 4 filter stages with different replacement schedules. Pre-filters (sediment and carbon) should be replaced every 6, 12 months. The RO membrane typically lasts 2, 5 years depending on water quality. Post-filters (polishing carbon) should be replaced annually. Check your specific system''s manual, higher TDS or iron in your source water shortens all these intervals.'
  - question: 'Can I tell if my filter needs changing by the taste of my water?'
    answer: 'Sometimes. A filter that needs replacement often allows chlorine taste and odor to return, which is detectable. But a filter that''s past its lead or PFAS capacity may still make your water taste fine while providing no protection. Taste is not a reliable indicator for health-effect contaminants. Track gallons and time, not taste.'
  - question: 'How do I know how many gallons my filter has processed?'
    answer: 'If your filter housing has a built-in counter or smart indicator, use that. For simple filters with no tracking, estimate based on household consumption. The average American uses about 1 gallon of drinking/cooking water per day. A family of 4 uses roughly 120 gallons per month from the kitchen tap. Compare that to your filter''s rated capacity and calculate your expected replacement date.'
---
...
*Related: [What Water Filter Do I Need?](/treatment/what-water-filter-do-i-need), match your specific contaminant to the right filter type before you buy.*
