---
title: 'Best Refrigerator Water Filters: OEM vs. Aftermarket and What They Actually Remove'
description: 'Most fridge filters are certified to NSF 42, taste and odor only. Not lead. Not PFAS. Here''s what to look for and whether OEM or aftermarket makes sense.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'best refrigerator water filters'
silo: 'treatment'
pageType: 'review'
layout: 'review'
...
1. Add a [Clearly Filtered pitcher](/treatment/clearly-filtered-pitcher-review/) for drinking water
2. Install an under-sink [reverse osmosis system](/treatment/reverse-osmosis/best-under-sink-ro-systems/) certified to NSF/ANSI 58
...
1. Locate your refrigerator's filter part number (usually on the filter itself or in the door jamb)
2. Search that part number in the [NSF product database](https://info.nsf.org/Certified/DWTU/)
3. Confirm whether it's certified to NSF 42 only or NSF 42 and 53

If it's NSF 42 only, and lead is a concern (older home, lead service lines, pre-1986 plumbing), add a point-of-use filter with NSF 53. A [PUR faucet filter](/treatment/pur-faucet-water-filter-review/) or [Brita Longlast+](/treatment/brita-water-filter-review/) at the kitchen sink handles this for well under $50.

If PFAS is a concern, the fridge filter isn't going to help regardless of its certification level. See the [PFAS contaminant page](/your-water/contaminants/pfas/) for context on where the exposure risk is highest and which treatment options actually address it.

For full contaminant coverage at the drinking tap, an under-sink RO is the most thorough solution available. A [countertop RO](/treatment/reverse-osmosis/best-countertop-ro-systems/) is the lower-commitment version.
...
For the NSF certification numbers and what each standard actually means, the [NSF standards explainer](/learn/nsf-certification-standards-explained/) has the full breakdown.
