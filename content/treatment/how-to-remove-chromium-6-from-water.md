...
faq:
  ...
  - question: 'What NSF certification covers chromium-6 removal?'
    answer: 'NSF/ANSI 58 is the standard for reverse osmosis systems. Systems certified under NSF 58 have been tested for a defined set of contaminants including chromium. When looking at a specific product, check the NSF certificate to confirm chromium is listed among the certified reductions for that model, not just that the system is "NSF 58 certified" broadly.'
  - question: 'How much chromium-6 does reverse osmosis remove?'
    answer: 'NSF 58-certified RO systems typically achieve 85-95% or greater reduction of total chromium in controlled testing. Real-world performance depends on membrane age, water pressure, and temperature. A membrane past its rated service life will show declining rejection rates for all contaminants including chromium.'
  - question: 'Is a whole-house filter needed to remove chromium-6?'
    answer: 'For most households, no. Chromium-6 health risk comes from ingestion. Treating drinking and cooking water at the point of use with an under-sink RO addresses the primary exposure pathway. Whole-house chromium-6 removal systems exist but are expensive and aren''t necessary for the majority of households unless levels are very high or there''s a specific skin exposure concern.'
  - question: 'How do I know if my RO system is actually removing chromium-6?'
    answer: 'Test your filtered water. A certified lab test for chromium on your filtered water output tells you your actual reduction rate. Do this after the system runs for 2-3 weeks to flush the new membrane. Repeat annually or whenever you replace the membrane.'
---
...
Before buying any RO system for chromium-6, check the NSF product database at [nsf.org/certified-products](https://www.nsf.org/certified-products). Search the specific model number and look at what contaminants are listed as certified reductions. You want to see "chromium (hexavalent)" or "chromium (trivalent)" and "chromium (VI)" in the certified claims. If the certificate doesn't show chromium reduction for that model, don't assume it handles chromium-6 just because it's NSF 58 certified.
...
**Step 1: Confirm chromium-6 is present.** Check your utility's Consumer Confidence Report or use the [best mail-in water tests](/testing/best-mail-in-water-tests/) to test your tap water before buying treatment equipment. If chromium-6 is below detectable levels in your water, you don't need specialized treatment.
...
- EWG, "Chromium-6 Is Widespread in US Tap Water": [ewg.org/research/chromium-6-widespread-in-us-tap-water](https://www.ewg.org/research/chromium-6-widespread-in-us-tap-water)
- EPA, "National Primary Drinking Water Regulations, Chromium": [epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations)
- NSF, "Certified Product Listings": [nsf.org/certified-products](https://www.nsf.org/certified-products)
