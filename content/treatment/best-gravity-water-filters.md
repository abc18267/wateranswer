---
title: 'Best Gravity Water Filters: Berkey, Alexapure, and the Countertop Gravity Options'
description: 'Gravity filters need no power and no plumbing. Here''s how Berkey, Alexapure, and AquaTru Carafe compare on contaminant removal, NSF certification, and real-world use.'
date: 2026-02-23
lastmod: 2026-02-23
primaryKeyword: 'best gravity water filter'
silo: 'treatment'
pageType: 'review'
layout: 'review'
...
faq:
  - question: 'Is Berkey NSF certified?'
    answer: 'No. Berkey water filters are not NSF certified. The company has provided manufacturer-commissioned third-party lab tests showing high contaminant reduction rates, but those are not the same as NSF certification, which requires independent testing through an accredited laboratory under a defined protocol. In 2023, the EPA classified Berkey filters as a pesticide device due to their antimicrobial claims, which created additional regulatory complications. If NSF certification is a requirement for you, Berkey is not the right choice. AquaTru Carafe is the countertop option with NSF documentation.'
  - question: 'What is the best gravity water filter?'
    answer: 'It depends on what you need. For certified PFAS and health contaminant removal with documented NSF testing, AquaTru Carafe is the only countertop gravity-style option with real certification. For off-grid capability, emergency prep, or situations where no electricity is available, Berkey is the most widely used and field-tested option despite lacking NSF certification. If certification matters most, AquaTru. If off-grid capability matters most, Berkey.'
  - question: 'Does Berkey remove PFAS?'
    answer: 'Berkey claims their Black Berkey elements remove PFAS compounds including PFOA and PFAS based on their own commissioned lab tests. However, these claims are not independently verified through NSF testing. NSF/ANSI 58 (the RO standard) is the accepted benchmark for PFAS removal certification. Berkey filters are not certified under NSF 58. If PFAS removal with independent certification is your goal, AquaTru Carafe (NSF P473 certified for PFAS) is the documented option.'
  - question: 'How does AquaTru Carafe compare to Berkey?'
    answer: 'AquaTru Carafe uses a reverse osmosis process assisted by an electric pump, with output collected in a glass carafe. It''s NSF 58 and P473 certified for PFAS, giving it the strongest independent documentation of any countertop filter. Berkey uses passive gravity through carbon-based filter elements, requires no electricity, holds up to 2.25 gallons, and is widely used for camping and emergency prep. AquaTru wins on documented contaminant removal. Berkey wins on off-grid capability and larger capacity without power.'
  - question: 'Are gravity filters good for emergency water purification?'
    answer: 'Yes, with caveats. Gravity filters like Berkey can process water from questionable sources including streams, rain catchment, and suspect tap water during emergencies. For biological contamination (bacteria, viruses), Berkey''s claimed removal rates are based on manufacturer-commissioned tests, not NSF 55 (UV) or NSF 53 (cyst) certification. For emergency preparedness, gravity filters are a reasonable option to have on hand. For complete pathogen certainty, pair any gravity filter with chemical treatment (iodine, chlorine tablets) or a UV purifier when treating from unknown sources.'
---
...
AquaTru Carafe wins on documented contaminant removal. NSF P473 for PFAS is the kind of independent certification that means something. If your municipal water has [PFAS](/your-water/contaminants/pfas/) and you want a countertop solution you can verify, AquaTru is the right choice.
...
The [best UV water purifiers](/treatment/best-uv-water-purifiers/) covers UV disinfection for households who need pathogen removal with independent certification.
...
For contaminant testing guidance, [NSF certification standards explained](/learn/nsf-certification-standards-explained/) is a good starting point for understanding what the certifications actually mean and why the distinction between manufacturer-commissioned testing and independent NSF certification matters.
