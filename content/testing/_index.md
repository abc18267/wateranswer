...
spokeHeading: "Testing Guides"
spokeCards:
  - title: "Best Water Test Kits"
    description: "At-home kits for quick checks on hardness, pH, lead, chlorine, and nitrates."
    href: "/testing/best-water-test-kits"
  - title: "Best Mail-In Water Tests"
    description: "Certified lab tests that cover PFAS, arsenic, bacteria, and the full contaminant panel."
    href: "/testing/best-mail-in-water-tests"
  - title: "How to Test Water at Home"
    description: "Step-by-step guide: at-home strips, digital meters, and when to go to a lab."
    href: "/testing/how-to-test-water-at-home"
  - title: "What Is TDS in Water?"
    description: "Total dissolved solids explained: what it measures, ideal ranges, and what high TDS means."
    href: "/testing/what-is-tds-in-water"
  - title: "How to Read Water Test Results"
    description: "MCLs, MCLGs, and detection limits. How to interpret what your lab report actually says."
    href: "/testing/how-to-read-water-test-results"
  - title: "How to Test Water Hardness at Home"
    description: "Test strips, hardness meters, and soap lather test. The fastest ways to check."
    href: "/testing/how-to-test-water-hardness-at-home"
  - title: "Get a Free Water Test from Your Utility"
    description: "Many utilities offer free or low-cost testing. How to request it and what to ask for."
    href: "/testing/get-free-water-test-from-utility"
...
faq:
  ...
  - question: 'What should I test for first?'
    answer: "For city water: lead (especially in pre-1986 homes), PFAS if you live near a military base or industrial site, and nitrates if you have a private concern. For well water: bacteria, nitrates, and iron as a baseline, then expand based on your location and land use nearby."
  - question: 'How often should I test my water?'
    answer: "City water customers: every 2, 3 years for peace of mind, or whenever you see changes in taste, odor, or color. Well water owners: bacteria and nitrates annually at minimum, comprehensive panel every 3, 5 years or when conditions change."
  - question: "Does my utility's CCR tell me everything?"
    answer: "No. The CCR reports results from the treatment plant exit point. It doesn't capture what happens in your building's plumbing, and it covers only regulated contaminants. PFAS testing under the EPA's UCMR5 program may not yet appear in your CCR."
---

Testing your water sounds complicated. It doesn't have to be.
...
Some states have their own equivalent certification. The EPA's website lists certified labs by state: [EPA Certified Laboratories](https://www.epa.gov/sdwa/learn-about-certified-laboratories).
